...
def main_menu():
    ...
    if user_input == 1: all_contacts()
    elif user_input == 2: print_contact()
    elif user_input == 3: add_contact()
    elif user_input == 4: remove_contact()
    elif user_input == 5: change_contact()
    elif user_input != 1 and user_input != 2 and user_input != 3 and user_input != 4 and user_input != 5: print('До новых встреч!')
...
def remove_contact():
    ...
    for i in range (len(new_list) - 1):
        if contact == new_list[i]: new_list.pop(i)
